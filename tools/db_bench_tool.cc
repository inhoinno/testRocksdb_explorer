...
DEFINE_int32(perf_level, ROCKSDB_NAMESPACE::PerfLevel::kEnableTimeExceptForMutex,
...
int db_bench_tool(int argc, char** argv) {
  ...
  ROCKSDB_NAMESPACE::Benchmark benchmark;
    ...
    fprintf(stdout, "benchmark.Run() start : %lu\n",FLAGS_env->GetSystemClock()->NowMicros());
  benchmark.Run();
    fprintf(stdout, "benchmark.Run() end : %lu\n",FLAGS_env->GetSystemClock()->NowMicros());
