...
LOG_FILE = "LOG_{0}_COMPACTIONSTYLE_BENCH_kKEY_vVALUE_cBLOCKCACHE_lLEVEL0_mMINMERGE_countCOUNT".format(testname)
OLDLOG_FILE=LOG_FILE
NAME="{0}_report_readamp_COMPACTIONSTYLE_BENCH_kKEY_vVALUE_cBLOCKCACHE_lLEVEL0_mMINMERGE_countCOUNT.csv".format(testname)
OLDNAME=NAME
...
I=0
bench=""
tailname = "COMPACTIONSTYLE_BENCH_kKEY_vVALUE_cBLOCKCACHE_lLEVEL0_mMINMERGE_countCOUNT.csv"
                    ...
                    for b in benchmark:
                        for l in l0_vars:
                            for minmerge in min_merge_width_vars:
                                ...
                                LOG_FILE = LOG_FILE.replace("KEY",str(k)).replace("VALUE",str(v)).replace("BLOCKCACHE",str(c)).replace("BENCH",b).replace("LEVEL0",str(l)).replace("MINMERGE",str(minmerge)).replace("COUNT",str(count))
