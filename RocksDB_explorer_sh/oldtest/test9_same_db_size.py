        ...
        for v in value_vars:
            for b in benchmark:
                ...
                if b == "readrandom":
                    ...
                    bench = "../db_bench --db=$DEV_PATH --use_direct_io_for_flush_and_compaction=true --benchmarks=$BENCHMARK --key_size=$k --value_size=$v --num=$NUM --compaction_style=$COMPACTIONSTYLE --use_existing_db=true --readonly=true --histogram --statistics  --report_interval_seconds=1 --report_file=$RESULT_PATH/$NAME >> $RESULT_PATH/$RESULT_FILE"
                elif b == "fillrandom": 
...
PARSER_RESULT="test9_COMPACTIONSTYLE_BENCH_kKEY_vVALUE.csv"
PARSER_RESULT2="test9_99_COMPACTIONSTYLE_BENCH_kKEY_vVALUE.csv"
PARSER_RESULT3="test9_avg_COMPACTIONSTYLE_BENCH_kKEY_vVALUE.csv"
