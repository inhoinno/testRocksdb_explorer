...
RESULT_FILE="test12_COMPACTIONSTYLE_BENCH_kKEY_vVALUE.txt"
NAME="test12_report_qps_COMPACTIONSTYLE_BENCH_kKEY_vVALUE.csv"
key_vars=[16]
value_vars=[128,256,512,1024,4096]
compactionstyle=[0,1] #0 Level , 1 Universal
benchmark=["fillrandom","readrandom", "fillseq", "readseq"]
#is readseq necessary?
I=0
bench=""

#
# Background compaction thread setting :  
# 기대하는 어떤 성능 그래프가 background compaction 으로 인해서 죽는것 같다
